...
<body>
    <div class="sidebar">
        ...
        <div class="create-user">student managment</div>
        <div class="add-user"><a href="signup.php">Add student</a></div>
        <div class="add-user" onclick="showForm('Department Head')"><a href="javascript:void(0)">view student</a></div>
        
        <div class="add-user" onclick="showForm('Registrar')"><a href="javascript:void(0)">view student</a></div>
        <div class="add-user"><a href="#">Give permission</a></div>
        <div class="add-user"><a href="#">track student</a></div>
    ...
    <div class="content">
        <div class="header">
            <h3>WELL COME TO DEPARTMENT HEAD DASHBOARD</h3>
