...
<body>
    <div class="sidebar">
        ...
        <div class="add-user"><a href="signup.php">view Student List</a></div>
        <div class="add-user"><a href="#">view grade</a></div>
        <div class="add-user"><a href="#">set commulative</a></div>
    ...
    <div class="content">
        <div class="header">
            <h3>WELL TO REGISTRAR DASHBOARD</h3>
