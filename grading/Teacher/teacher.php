...
<body>
    <div class="sidebar">
        ...
        <h2>teacher's DB</h2>
        <div class="create-user">manage student</div>
        <div class="add-user"><a href="signup.php">view Student</a></div>
        <div class="add-user" onclick="showForm('Teacher')"><a href="javascript:void(0)">creat attendance</a></div>
        <div class="add-user" onclick="showForm('Registrar')"><a href="javascript:void(0)">creat exam</a></div>
        <div class="add-user"><a href="#">add result</a></div>
        <div class="add-user"><a href="#">view complain</a></div>
    ...
    <div class="content">
        <div class="header">
            <h3>WELL TO TEACHER DASHBOARD</h3>
